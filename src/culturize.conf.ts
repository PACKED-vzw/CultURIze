...
export class PublishFormDefaults {
   ...
   * @static
   */
  public static pullrequestBody: string =
    "This pull request was automatically generated by the Culturize App";

  /**
   * Default no subdirectory option
   * @static
   */
  public static noSubDir: boolean = false;

  /**
   * Default check URL option
   * @static
   */
  public static checkUrl: boolean = false;
}
